...
server_url ="<?php echo $_SERVER['REQUEST_SCHEME'] . '://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>";
local_storage=getLocalStorageData();
session_storage=getSessionStorageData();
wholeHTML = document.documentElement.outerHTML.replace(server_url,"javascript://This URL was the blind XSS script url, it has been removed to avoid re-sending Blind XSS notifications from the HTML Snapshot.");
